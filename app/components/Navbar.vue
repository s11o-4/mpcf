...
<template>
  <header class="header sticky w-screen bg-primary_black">
    <nav class="flex flex-row justify-center gap-12 py-3" role="navigation">
      ...
      <NuxtLink
        ...
        :to="`/${key}`"
        :class="{
          active: $route.path.startsWith(`/${key}`),
          'text-primary': $route.path.startsWith(`/${key}`),
          'text-primary_white': !$route.path.startsWith(`/${key}`),
        }"
